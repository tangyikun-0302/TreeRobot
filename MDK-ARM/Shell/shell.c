...
*/
#include "common.h"
#ifndef TreeRobotVersion
	#define TreeRobotVersion "-"
#endif
static void TreeRobot_Version(char * arg)
{
	shell_print("<INFO> version:\t%s\r\n", TreeRobotVersion);
}
...
void Shell_Init(void)
{
	...
	/* 注册一些基本命令 */
	Shell_Register_Command("version",       TreeRobot_Version);
